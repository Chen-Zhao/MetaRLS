...
snptest_v2.5.4-beta2 -data $i.filterMAF0005INFO05.gatk.rmdupAC.vcf.gz ../sampleinfo.snptest.sample -filetype vcf  -genotype_field GP -o $i.filterMAF0005INFO05.gatk.snptest.out -frequentist 1 -method expected -pheno chd -hwe -log $i.filterMAF0005INFO05.gatk.snptest.log &
done

i="X"
zcat $i.filterMAF0005INFO05.gatk.vcf.gz | awk 'NR!=8' | bgzip -c /dev/stdin > $i.filterMAF0005INFO05.gatk.rmdupAC.vcf.gz ;
snptest_v2.5.4-beta2 -data $i.filterMAF0005INFO05.gatk.rmdupAC.vcf.gz ../sampleinfo.snptest.sample -filetype vcf  -genotype_field GP -o $i.filterMAF0005INFO05.gatk.snptest.out \
-method newml \
-frequentist 1 \
-pheno chd \
-stratify_on sex \
-cov_names sex \
-hwe -log $i.filterMAF0005INFO05.gatk.snptest.log &
