...
paste CHD_AllQC_rsid.fliped.ref.1.dbSNP146 CHD_AllQC_rsid.fliped.ref.2.bim | awk '$3==$7{OFS="\t";
      if(($10=="-" && (length($4)==2 || length($5)==2) ) || ($11=="-" && (length($4)==2 || length($5)==2))){$9=$2;$10=$4;$11=$5;} 
...
mv CHD_AllQC_rsid.fliped.ref.vcf impute.vcf
bgzip impute.vcf
...
java -jar ~/usr/jar/CreateSequenceDictionary.jar R=download/human_g1k_v37.ensembl_1-X.fasta O=download/human_g1k_v37.ensembl_1-X.dict
java -Xmx24G -jar ~/usr/jar/GenomeAnalysisTK_3.5.jar -T LeftAlignAndTrimVariants  -R download/human_g1k_v37.ensembl_1-X.fasta --variant imputechrensembl.vcf.gz  -o imputechrensembl.leftaligned.vcf
bcftools norm -f ${dbpath}/human_g1k_v37.ensembl_1-X.fasta imputechrensembl.vcf.gz -O z > imputechrensembl.norm.vcf.gz

java -Xmx24G -jar ~/usr/jar/GenomeAnalysisTK_3.5.jar -T LeftAlignAndTrimVariants  -R download/human_g1k_v37.ensembl_1-X.fasta --variant test.vcf  -o imputechrensembl.leftaligned.vcf

bcftools norm -cw -f ${dbpath}/human_g1k_v37.ensembl_1-X.fasta imputechrensembl.vcf.gz | bgzip -c /dev/stdin > imputechrensembl.checked.vcf.gz
