...
impute by HRC panel and UK10K+1000g panel
HRC panel for all data and test data
UK10k+1000g panel for all data and test dat, stand pipelien and shapeit2 pipeline
...
zcat 22.vcf.gz | extractbyquery.pl ../imputechrensembl.test.norm.true.vcf 3 /dev/stdin 3 | grep -v '#' > imputechrensembl.test.norm.pred.vcf
...
zcat 22.pbwt_reference_impute.vcf.gz | extractbyquery.pl ../imputechrensembl.test.norm.true.vcf 3 /dev/stdin 3 | grep -v '#' > imputechrensembl.test.norm.pred.vcf
extractbyquery.pl imputechrensembl.test.norm.pred.vcf 3 ../imputechrensembl.test.norm.true.vcf 3 | grep -v '#' > imputechrensembl.test.norm.true.vcf
...
setwd("/home/chenzhao/globusshare/imputecathy10k100gQC.vcfs")
setwd("/home/chenzhao/globusshare/imputecathyQC.vcfs")
setwd("/home/chenzhao/globusshare/imputecathy10k100gQCshapeit2.vcfs")
