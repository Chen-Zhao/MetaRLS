...
awk '$1==0' CHD_AllQC_rsid.SEXasX.result.bim | cut -f 2 | sed -e 's/rs//g' > CHD_AllQC_rsid.SEXasX.result.unmapped.list
...
cp CHD_AllQC_rsid.SEXas23.result.bim CHD_AllQC_rsid.tmp.bim

plink --bfile CHD_AllQC_rsid.tmp --flip CHD_AllQC_rsid.SEXas23.result.snpflip_output.reverse --make-bed --out CHD_AllQC_rsid.fliped
