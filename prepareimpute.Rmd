...
for i in {1..22} ; do 
snptest_v2.5.4-beta2 -data $i.filterMAF0005INFO05.bcftools.gen.gz ../sampleinfo.snptest.sample -o $i.filterMAF0005INFO05.bcftools.NEWMLonSEX.out \
-method expected \
-frequentist 1 \
-pheno chd \
-cov_names sex mds_1 mds_2 mds_3 mds_4 mds_5 mds_6 mds_7 mds_8 mds_9 mds_10 \
-hwe -log $i.filterMAF0005INFO05.bcftools.NEWMLonSEX.out &
done
